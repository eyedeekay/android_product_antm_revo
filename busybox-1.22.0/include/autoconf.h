 ...
 */
#define AUTOCONF_TIMESTAMP "2016-01-23 22:56:25 EST"
...
#define CONFIG_CROSS_COMPILER_PREFIX "/usr/local/android-ndk/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-"
...
#define CONFIG_EXTRA_CFLAGS "-DANDROID -D__ANDROID__ -DSK_RELEASE -nostdlib -march=armv7-a -msoft-float -mfloat-abi=softfp -mfpu=neon -mthumb -mthumb-interwork -fpic -fno-short-enums -fgcse-after-reload -frename-registers"
...
#define CONFIG_EXTRA_LDLIBS "dl m c gcc"
